...
import com.simplyti.server.http.api.context.StreamAnyContextFactory;
...
public class HttpMethodApiBuilderImpl implements HttpMethodApiBuilder {
	...
	public RequestTypableApiBuilder post(String path) {
		return new RequestBodyTypableApiBuilderImpl(anyWithBodyContextFactory,requestTypedContextFactory,requestResponseTypedContextFactory,responseTypedWithBodyContextFactory,streamAnyContextFactory,operations,HttpMethod.POST, path);
	}

	@Override
	public RequestTypableApiBuilder put(String path) {
		return new RequestBodyTypableApiBuilderImpl(anyWithBodyContextFactory,requestTypedContextFactory,requestResponseTypedContextFactory,responseTypedWithBodyContextFactory,streamAnyContextFactory,operations,HttpMethod.PUT, path);
	}

	@Override
	public RequestTypableApiBuilder patch(String path) {
		return new RequestBodyTypableApiBuilderImpl(anyWithBodyContextFactory,requestTypedContextFactory,requestResponseTypedContextFactory,responseTypedWithBodyContextFactory,streamAnyContextFactory,operations,HttpMethod.PATCH, path);
	}
