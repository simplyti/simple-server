...
public class DefaultFinishableHttpRequestBuilder extends AbstractFinishableHttpRequestBuilder<FinishableHttpRequestBuilder> implements FinishableHttpRequestBuilder {
	...
	public DefaultFinishableHttpRequestBuilder(ChannelProvider channelProvider, EventLoopGroup eventLoopGroup, HttpMethod method, String path, Map<String,Object> params, HttpHeaders headers, boolean checkStatus) {
