...
public class NotFoundFullHandlerModule extends AbstractModule implements DefaultBackendFullRequestHandler{

	@Override
	protected void configure() {
		bind(DefaultBackendFullRequestHandler.class).to(NotFoundFullHandlerModule.class).in(Singleton.class);
	}
