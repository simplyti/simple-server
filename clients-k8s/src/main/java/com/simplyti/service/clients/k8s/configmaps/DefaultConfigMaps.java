...
public class DefaultConfigMaps extends DefaultK8sApi<ConfigMap> implements ConfigMaps {
    ...
    public DefaultConfigMaps(EventLoopGroup eventLoopGroup, HttpClient http, Json json) {
    ...
    public NamespacedConfigMaps namespace(String namespace) {
        return new DefaultNamespacedConfigMaps(eventLoopGroup(), http(), json(), K8sAPI.V1, namespace, RESOURCE, ConfigMap.class, LIST_TYPE, EVENT_TYPE);
    }
}
