...
public class DefaultPods extends DefaultK8sApi<Pod> implements Pods {
	...
	public DefaultPods(EventLoopGroup eventLoopGroup, HttpClient http) {
		super(eventLoopGroup,http,K8sAPI.V1,RESOURCE,LIST_TYPE,EVENT_TYPE);
	}

	@Override
	public NamespacedPods namespace(String namespace) {
		return new DefaultNamespacedPods(eventLoopGroup(),http(),K8sAPI.V1,RESOURCE,LIST_TYPE,EVENT_TYPE,namespace);
	}
