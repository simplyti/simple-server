...
public class DefaultGenericClient extends AbstractClient<GenericRequestBuilder> implements GenericClient {
	...
	public DefaultGenericClient(EventLoopGroup eventLoopGroup, Bootstrap bootstrap, Endpoint endpoint, SslProvider sslProvider, DefaultClientMonitor monitor,
			int poolSize, boolean unpooledChannels, long poolIdleTimeout, long readTimeoutMillis, Consumer<Channel> customInit) {
		super(bootstrap,eventLoopGroup,unpooledChannels, new GenericClientChannelPoolHandler(readTimeoutMillis, customInit), sslProvider, monitor , monitor, poolSize, poolIdleTimeout);
