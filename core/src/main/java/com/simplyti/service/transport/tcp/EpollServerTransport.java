...
public class EpollServerTransport extends AbstractTcpServerTransport {
	
	@Inject
	public EpollServerTransport(Provider<EventLoopGroup> eventLoopGroup, @StartStopLoop Provider<EventLoop> startStopLoop,
